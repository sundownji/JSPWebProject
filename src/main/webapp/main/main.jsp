	...
	<div id="wrap">
		...
		<div class="main_contents">
			<div class="main_con_left">
				...
				<form action="../member/LoginProcess.jsp" method="post" name="loginFrm" onsubmit="return validateForm(this);">
					...
					<p style="padding:10px 0px 10px 10px"><span style="font-weight:bold; color:#333;">
					        <%= session.getAttribute("UserName") %>님,</span> 반갑습니다.<br />로그인 하셨습니다.</p>
			...
			<div class="main_con_center">
				<p class="main_title"><img src="../images/main_title02.gif" alt="공지사항 NOTICE" /><a href="../space/sub01list.jsp?tname=notice_board"><img src="../images/more.gif" alt="more" class="more_btn" /></a></p>
				<!--공지사항 게시물 4개  -->
